...
import  webDevIcon from '../assets/images/icons/web-1.svg';
import  MobileAppIcon from '../assets/images/icons/app-notification.svg';
import  UiUxIcon  from '../assets/images/icons/ux-browser.svg';
import  MlAiIcon from '../assets/images/icons/chip-brain.svg';
      ...
      <div className={styles.servicesWeProvideContainer}>
        ...
        <div className={styles.servicesGrid}>
          <div className={`${styles.serviceCard} `} >
            ...
            <h2 className="text-3xl font-semibold mb-3">Custom Software Development</h2>
          ...
          <div className={styles.iconWrapper}>
            ...
            <h2 className="text-3xl font-semibold mb-3">Web App Development</h2>
          ...
          <div className={styles.iconWrapper}>
            ...
            <h2 className="text-3xl font-semibold mb-3">Mobile App Development</h2>
          ...
          <div className={styles.iconWrapper}>
            ...
            <h2 className="text-3xl font-semibold mb-3">AI/ML Development</h2>
          ...
          <div className={`${styles.serviceCard} `}>
            ...
            <h2 className="text-3xl font-semibold mb-3">User Experience and Design</h2>
